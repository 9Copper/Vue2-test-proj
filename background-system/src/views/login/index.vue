  ...
  <div class="login-container">
    ...
    >
      ...
      <div class="captcha-container">
        <el-form-item prop="loginId" class="captcha-input">
          <span class="svg-container">
        ...
        <div class="captcha-img" v-html="svg" @click="getCaptchaFunc"></div>
      </div>
      <!-- 7 天内免登录 -->
        ...
        if (valid) {
          ...
          this.$store
            ...
            .then(() => {
              ...
              //获取右上角头像
              this.$store.dispatch("user/getAvatar", this.form.avatar);
              this.loading = false;
            })
            .catch((res) => {
